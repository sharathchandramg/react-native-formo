  ...
  renderInputField = (attributes, theme) => {
    ...
    return (
      <AppNBInput
        ...
        value={
          attributes.value &&
          attributes.value.curr_value &&
          attributes.value.curr_value.toString()
        }
      />
    );
  };
  ...
  renderModal = () => {
    ...
    let currencyType =
      typeof attributes.value !== "undefined" && attributes.value !== null
        ? attributes.value.curr_type
        : this.state.value.curr_type;
    return (
      <Modal
        animationType="slide"
        transparent={true}
  ...
  renderCurrencyTypePicker = () => {
    ...
    if (Platform.OS !== "ios") {
      ...
      return (
        ...
        >
          <AppNBText size={16} style={{ color: theme.inputColorPlaceholder }}>
            {currencyType}
          </AppNBText>
        </TouchableOpacity>
      );
